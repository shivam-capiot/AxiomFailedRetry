...
public class XMLUtils {
	...
	public static String getValueAtXPath(Element xmlElem, String elemXPath) {
		...
		return evaluate(xpathNodes, funcArgs);
	}

	public static String evaluate(Node[] xpathNodes, String[] funcArgs) {
		return (xpathNodes != null && xpathNodes.length > 0) ? XMLUtils.getNodeValue(xpathNodes[0]) : "";
	}
	
	public static String optValueAtXPath(Element xmlElem, String elemXPath, String dftVal) {
		String value = getValueAtXPath(xmlElem, elemXPath);
		return value == null || value.isEmpty() ? dftVal : value;
	}
	...
	public static String[] getAllValuesAtXPath(Element xmlElem, String elemXPath) {
		...
		for (Node xpathNode : xpathNodes) {
			valueList.add(evaluate(new Node[] {xpathNode}, funcArgs));
		}
	...
	public static Node[] getNodesAtXPath(Element xmlElem, String elemXPath) {
		...
		try {
			...
			logger.warn("Error occured while proccessing nodes at Xpath",x);
			return emptyNodeArr;
		}
	}
