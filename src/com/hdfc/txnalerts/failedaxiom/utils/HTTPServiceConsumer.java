...
public class HTTPServiceConsumer {
	...
	private static Logger logger = Logger.getLogger(HTTPServiceConsumer.class);
	...
	public static Element consumeXMLService(String tgtSysId, URL tgtSysURL, Map<String, String> httpHdrs, String httpMethod, long svcTimeout, Element reqElem) {
		return consumeXMLService(tgtSysId, tgtSysURL, null, httpHdrs, httpMethod, svcTimeout, reqElem);
	}

	public static Element consumeXMLService(String tgtSysId, URL tgtSysURL, Proxy httpProxy, Map<String, String> httpHdrs, String httpMethod, long svcTimeout, Element reqElem) {
	...
	public static JSONObject consumeXMLReturnJSONService(String tgtSysId, URL tgtSysURL, Map<String, String> httpHdrs, String httpMethod, long svcTimeout, Element reqElem) throws Exception {
		return consumeXMLReturnJSONService(tgtSysId, tgtSysURL, null, httpHdrs, httpMethod, svcTimeout, reqElem); 	
	}
	...
	public static JSONObject consumeXMLReturnJSONService(String tgtSysId, URL tgtSysURL, Proxy httpProxy, Map<String, String> httpHdrs, String httpMethod, long svcTimeout, Element reqElem) throws Exception {
		String resStr = consumeServiceV3(tgtSysId, tgtSysURL, httpProxy, httpHdrs, httpMethod, svcTimeout, XMLTransformer.toString(reqElem)).getPayloadString();
		if (resStr != null) {
			try {
				return new JSONObject(new JSONTokener(new ByteArrayInputStream(resStr.getBytes())));
	...
	private static HttpTemplate consumeServiceV3(String tgtSysId, URL tgtSysURL, Proxy httpProxy, Map<String, String> httpHdrs, String httpMethod, long serviceTimeout, String payload) {
		...
		try {
			logger.info("URL that is getting hit: "+tgtSysURL.toString());
			svcConn = (HttpURLConnection) ((httpProxy != null) ? tgtSysURL.openConnection(httpProxy) : tgtSysURL.openConnection());
			svcConn.setRequestMethod(httpMethod);
			svcConn.setReadTimeout((int) serviceTimeout);
...
//	}
	...
	private static String readInputStreamAsString(InputStream inStream, String contentType, String contentEncoding) throws IOException {
		...
		try (InputStream readStream = getInputStreamForContentEncodings(inStream, new ArrayList<>( Arrays.asList(contentEncodings)))) {
			int readBytesLen = 0;
...
//	}
	...
	public static JSONObject getErrorMessage(String tgtSysId, String urlToRead, Map<String, String> httpHdrs,
		...
		try {
			...
			svcConn.setRequestMethod(httpMethod);
			String reqJsonStr = reqJson!=null ? reqJson.toString() : "{}"; 
